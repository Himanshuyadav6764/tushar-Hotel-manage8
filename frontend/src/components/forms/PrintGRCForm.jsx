    ...
    return (
        <div className="add-payment-form-premium" style={{ height: '100%', width: '100%', boxSizing: 'border-box' }}>
            <div className="add-payment-body">
                {/* Guest & Registration Summary Card */}
                <div className="payment-summary-card">
                    <div className="summary-header">
                        <span className="ref-tag">REGISTRATION</span>
                        <span className="ref-number">{b.bookingId || b._id || 'N/A'}</span>
                    </div>
                    ...
                    <div className="summary-main">
                        ...
                        <div className="summary-column">
                            <div className="summary-item">
                                <label>MOBILE</label>
                                <span>{b.mobileNumber || 'N/A'}</span>
                            </div>
                            <div className="summary-item">
                                <label>GUESTS</label>
                                <span>{b.numberOfGuests || 1} Person(s)</span>
                            </div>
                            <div className="summary-item">
